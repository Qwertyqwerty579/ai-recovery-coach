        ...
        <Card className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <input 
                    ...
                    required 
                    className="w-full bg-gray-700/50 p-3 rounded-lg text-white border-none focus:ring-2 focus:ring-emerald-400"
                />
                <input 
                    type="password" 
                ...
                <p className="text-center text-gray-400 text-sm">
                    ...
                    <button type="button" onClick={onGoToRegister} className="text-emerald-400 hover:underline">
                        Register
                    </button>
                </p>
            </form>
        ...
        <Card className="max-w-md mx-auto w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <input 
                    ...
                    className="w-full bg-gray-700/50 p-3 rounded-lg text-white border-none focus:ring-2 focus:ring-emerald-400"
                />
                <button type="submit" className="w-full bg-blue-500 text-white font-bold py-3 rounded-lg hover:bg-blue-600 transition">
                    Register
                </button>
                {error && <p className="text-red-400 text-sm text-center">{error}</p>}
                ...
                <p className="text-center text-gray-400 text-sm">
                    ...
                    <button type="button" onClick={onGoToLogin} className="text-emerald-400 hover:underline">
                        Log In
                    </button>
                </p>
            </form>
...
const Dashboard = () => {
    ...
    const handleAddWorkout = async (e) => {
        ...
        try {
            ...
            if (planResponse.status === 401) { logout(); return; } 
            if (!planResponse.ok) {
...
export default function App() {
    ...
    const renderPage = () => {
        const isProtected = page === 'dashboard' || page === 'chat';
                ...
                <div className="relative z-10">
                    {page !== 'home' && token && (
                        <nav className="flex justify-center gap-4 mb-8">
                            ...
                            <button onClick={logout} className="px-4 py-2 rounded-full transition text-red-400 hover:bg-white/10">
                                Log Out
                            </button>
                        </nav>
                    )}
